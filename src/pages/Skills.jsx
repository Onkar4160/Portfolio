...
const SKILLS = [
  ...
  { name: "Kotlin", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kotlin/kotlin-original-wordmark.svg" },
...
const ROWS = [
  [
    { title: "Programming Languages", items: ["Python", "C", "C++", "Java", "Kotlin"] },
    { title: "AI/ML", items: ["Deep Learning", "Neural Networks (ANN, CNN, RNN, LSTM)", "NLP", "Computer Vision", "K-Means Clustering"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React"] },
  ],
  [
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git"] },
    { title: "Frameworks & Libraries", items: ["TensorFlow", "PyTorch", "NumPy", "Pandas", "Scikit-learn", "PyTorch", "Matplotlib", "Seaborn"] },
