  ...
  personal: [
    {
      ...
      photos: ["/gallery/kailasgad1.jpg", "/gallery/kailasgad2.jpg"],
    },
    {
      id: 2,
      caption:
        "Weekend getaway to clear my head 🌄 Sometimes inspiration strikes when you’re away from the screen.",
      photos: ["/gallery/sunset.jpg", "/gallery/with_bike.jpg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Connecting surplus meals to local NGOs and volunteers—so every plate makes a difference.",
      photos: ["/gallery/surplusShift1.jpg", "/gallery/surplusShift2.jpg", "/gallery/surplusShift3.jpg"],
    },
  ],
  achievements: [
    {
